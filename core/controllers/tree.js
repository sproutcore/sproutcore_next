...
import { ObjectController } from "./object_controller.js";
...
*/
export const TreeController = ObjectController.extend(SelectionSupport,
/** @scope TreeController.prototype */ {
  ...
  */
  ...
  /**
    Returns an Array object that actually will represent the tree as a
  ...
  _contentDidChange: function () {
    ...
    if (content) {
      if (arrangedObjects) {
        ...
        arrangedObjects = TreeItemObserver.create({ item: content, delegate: this });
