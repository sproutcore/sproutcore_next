...
import { BRANCH_CLOSED, BRANCH_OPEN, LEAF_NODE } from "../system/constants.js";
...
export const TreeItemContent = {
  ...
  */
  ...
  /**
    ...
    BRANCH_OPEN, BRANCH_CLOSED or LEAF_NODE.
  ...
  */
  treeItemDisclosureState: function(parent, idx) {
    return this.get('treeItemIsExpanded') ? BRANCH_OPEN : BRANCH_CLOSED;
  },
  ...
  */
  ...
  /**
    ...
    @returns {IndexSet} branch indexes
  */
  treeItemBranchIndexes: function(parent, index) {
    ...
    for(idx=0;idx<lim;idx++) {
      ...
      if (item.treeItemDisclosureState(this,idx)!==LEAF_NODE) ret.add(idx);
    }
