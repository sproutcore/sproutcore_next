...
/**
  ...
  To schedule a basic timer, you can simply call Timer.schedule() with
...
/** @scope Timer.prototype */ {
  ...
  */
  invalidate: function() {
    ...
    // return to pool...
    if (this.get('isPooled')) Timer.returnTimerToPool(this);
    return this ;
  },
  ...
  */
  ...
  /**
    ...
    @params {Object} props properties to copy over
...
/*
  ...
  execute.  This is the same as calling Time.create({ props }).schedule().
  ...
  @params {Object} props Any properties you want to set on the timer.
...
/**
  ...
  a new instance.
*/
Timer.timerFromPool = function(props) {
...
*/
Timer.returnTimerToPool = function(timer) {
