...
*/
export const SCSet = mixin({}, Observable, Enumerable, Freezable, Copyable,
  {
    ...
    /**
      ...
      @param {SCObject[]|SCSet} [items] items to add
      @return {SCSet}
    */
    create: function (items) {
      var ret, idx, pool = SCSet._pool,
    ...
    */
    contains: function (obj) {
      ...
      var idx = this[hashFor(obj)];
      return (!none(idx) && (idx < this.length) && (this[idx] === obj));
    },
    ...
    /**
      ...
      @param {SCSet} obj the other object
      @returns {Boolean}
    */
    ...
    */
    addSetObserver: function (setObserver) {
      ...
      if (!this.setObservers) {
        this.setObservers = CoreSet.create();
      }
    ...
    */
    add: function (obj) {
      ...
      var hashFunc,
        guid = ((hashFunc = obj.hash) && (typeof hashFunc === "function")) ? hashFunc.call(obj) : guidFor(obj),
        idx = this[guid],
        len = this.length;
    ...
    */
    remove: function (obj) {
      ...
      var hashFunc,
        guid = (obj && (hashFunc = obj.hash) && (typeof hashFunc === T_FUNCTION)) ? hashFunc.call(obj) : guidFor(obj),
        idx = this[guid],
        len = this.length,
        tmp;
      ...
      if (idx < (len - 1)) {
        ...
        guid = (tmp && (hashFunc = tmp.hash) && (typeof hashFunc === T_FUNCTION)) ? hashFunc.call(tmp) : guidFor(tmp);
        this[guid] = idx;
      }
    ...
    */
    destroy: function () {
      ...
      if (!this.isObservable) SCSet._pool.push(this.clear());
...
SCSet.constructor = SCSet;

// Make SC.Set look a bit more like other enumerables

/** @private */
SCSet.clone = SCSet.copy;

/** @private */
SCSet.push = SCSet.unshift = SCSet.add;

/** @private */
SCSet.shift = SCSet.pop;

// add generic add/remove enumerable support

/** @private */
SCSet.addObject = SCSet.add;

/** @private */
SCSet.removeObject = SCSet.remove;
...
/** @class CoreSet
  ...
  @since SproutCore 1.0
*/
export const CoreSet = beget(SCSet);

/** @private */
CoreSet.isObservable = false;
