...
import { A, beget, mixin, typeOf } from "./base.js";
...
/** @class
  ...
  member objects.  All builders implement Enumerable in the fn() method.

      CoreQuery = Builder.create({
        ...
      }) ;
      
      CoreQuery = new Builder(properties) {
        ...
      } ;
  ...
  @constructor
*/
export const Builder = function (props) { return Builder.create(props); };
