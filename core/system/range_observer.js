...
export const RangeObserver = {
  ...
  */
  ...
  /**
    ...
    @returns {RangeObserver} extended range observer class
  */
  ...
  */
  update: function (source, indexSet) {
    if (this.indexes && this.indexes.isEqual(indexSet)) {
      return this;
    }
  ...
  */
  beginObserving: function () {
    ...
    var observing = this.observing = this.observing || CoreSet.create();
    ...
    ObserverQueue.addPendingRangeObserver(this);
        ...
        func = this._setupPendingForEach = function (idx) {
          ...
          if (obj && obj.addObserver) {
            ...
            if (key == null) {
              ...
              self[guid] = IndexSet.create(key).add(idx);
            }
  ...
  */
  ...
  /**
    ...
    @param {IndexSet} changes optional set of changed indexes
    @returns {RangeObserver} receiver
  */
  ...
  */
  objectPropertyDidChange: function (object, key, value, rev) {
    ...
    if (index && !index.isIndexSet) {
      index = this[guid] = IndexSet.create(index).freeze();
    }
