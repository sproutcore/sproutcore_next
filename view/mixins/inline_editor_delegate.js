...
/**
  ...
  This delegate is consulted by view implementing InlineEditable and
  InlineEditor and controls the lifecycle of the editor as well as begin
  notified of events in the editing process.
  
  By default it edits an LabelView using an InlineTextFieldView.
...
*/
export const InlineEditorDelegate = {
  ...
  /**
    ...
    @params {InlineEditable} editable the view that is begin edited
    @returns {InlineEditor} an editor for the view
  */
  ...
  /**
    ...
    @params {InlineEditor} editor the editor being released
    @returns {Boolean} true if it was successfully released
  */
  ...
  /**
    Determines if the view should be allowed to begin editing and returns true if
    ...
    @params {InlineEditable} editable the view that is attempting to begin editing
    @params {Object} value the current value of the view
    @returns {Boolean} true if the view is allowed to edit
  */
