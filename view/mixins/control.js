...
export const Control = SC.mixin(SC.clone(ContentValueSupport),
/** @scope Control.prototype */{
  ...
  */
  ...
  /**
    ...
    If you add a control as part of an FormView, then the form view will
  ...
  */
  ...
  /**
    ...
    Some controls will default to AUTO_CONTROL_SIZE, which will allow you
    ...
    this, a warning will be issued. If you don't care, use CALCULATED_CONTROL_SIZE.
  ...
  */
  renderMixin: function (context, firstTime) {
    ...
    names.mixed = sel === MIXED_STATE;
    names.sel = sel && (sel !== MIXED_STATE);
