...
/**
  ...
  See InlineTextFieldView for an example of an implementation of
  InlineEditor.
*/
export const InlineEditor = {
  ...
  */
  ...
  /**
    ...
    @param {View} editable the view being edited
    @returns {Boolean} whether the editor was able to successfully begin editing
  */
  beginEditing:function(editable) {
    if(this.get('isEditing') || !editable || !editable.isInlineEditable) return false;
  ...
  */
  ...
  /**
    ...
    Will fail if the editor is not editing or if the delegate returns false to
  ...
  */
  commitEditing:function() {
    ...
    if(del && !del.inlineEditorShouldCommitEditing(this, this.get('value'), target)) return false;
  ...
  */
  discardEditing:function() {
    ...
    if(del && !del.inlineEditorShouldDiscardEditing(this, target)) return false;
