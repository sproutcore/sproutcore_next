...
export const containerSwapFadeColorTransition = /** @scope ContainerView */ {

 /** @class
    Provides fade through color transitions to ContainerView.  The old
    ...
    @extends ViewTransitionProtocol
    @see View#animate for other timing functions.
    @since Version 1.10
  */
  FADE_COLOR: {
    ...
    willBuildInToView: function (container, content, previousStatechart, options) {
      ...
      color = Color.from(options.color || 'black');
      colorView = View.create({
