...
export const IMAGE_FAILED_ERROR = SC.$error("Image.FailedError", "Image", -101) ;
...
/**
  ...
  Note that if you use the ImageView class, it will use this image queue
  ...
  error object, it will be one of IMAGE_ABORTED_ERROR or
  IMAGE_FAILED_ERROR.
...
*/
export const imageQueue = SC.Object.create(/** @scope imageQueue.prototype */ {
  ...
  */
  ...
  _imageDidAbort: function() {
    SC.run(function() {
      imageQueue.imageStatusDidChange(this.entry, imageQueue.ABORTED);
    }, this);
  },

  _imageDidError: function() {
    SC.run(function() {
      imageQueue.imageStatusDidChange(this.entry, imageQueue.ERROR);
    }, this);
  },

  _imageDidLoad: function() {
    SC.run(function() {
      imageQueue.imageStatusDidChange(this.entry, imageQueue.LOADED);
    }, this);
  },
  ...
  imageStatusDidChange: function(entry, status) {
    ...
    switch(status) {
      case this.LOADED:
        ...
        break;
      case this.ABORTED:
        value = IMAGE_ABORTED_ERROR;
        break;
      case this.ERROR:
        value = IMAGE_FAILED_ERROR ;
        break;
      default:
        value = IMAGE_FAILED_ERROR ;
        break;
