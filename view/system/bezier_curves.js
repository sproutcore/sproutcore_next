...
/** @private Kept private until fully fleshed out.
  A cubic bezier equation. Used by the easingCurve function.
 */
export const CubicBezierEquation = function (C1, C2, C3, C4) {
...
/** @private Kept private until fully fleshed out (name change?).
  ...
  */
export const easingCurve = function (C2x, C2y, C3x, C3y) {
  ...
  var equation = new CubicBezierEquation(C1, C2, C3, C4);
