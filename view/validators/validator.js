...
*/
export const Validator = SC.Object.extend(
/** @scope Validator.prototype */ {
...
/**
  ...
  @param {FormView} form The form this field belongs to. (optional)
  @param {View} view The view the value is required for.
...
*/
  ...
  /**
    ...
    @param {FormView} form The form this field belongs to. (optional)
    @param {View} view The view this value was pulled from.
  ...
  */
  ...
  /**
    ...
    @param {FormView} form the form this view belongs to
    @param {View} field the field to validate.  Responds to fieldValue.
  ...
  */
  validateError: function(form, field) { 
    return SC.$error(
      String.loc("Invalid.General(%@)", field.get('fieldValue')),
      field.get('fieldKey')) ; 
  },
  ...
  /**
    ...
    if validate() returns false.  This method should return VALIDATE_OK if validation
    succeeded or an error object if it fails.
  
    @param {FormView} form the form for the field
    @param {View} field the field to validate
    @param {Object} oldValue: the value of the field before the change

    @returns VALIDATE_OK or an error object.
  
  */
  validateChange: function(form, field, oldValue) { 
    return this.validate(form,field) ? VALIDATE_OK : this.validateError(form, field);
  },
  ...
  */  
  ...
  /**
    ...
    Unlike the other methods, you should return VALIDATE_NO_CHANGE if you
    did not actually validate the partial string.  If you return 
    VALIDATE_OK then any showing errors will be hidden.
  
    @param {FormView} form the form for the field
    @param {View} field the field to validate

    @returns VALIDATE_OK, VALIDATE_NO_CHANGE or an error object.
  */  
...
Validator.mixin(/** @scope Validator */ {
  ...
  */
  ...
  /**
    ...
    visible, you should name your validator under the Validator base.
    for example Validator.Number would get used for the 'number' 
    validator key.
    ...
    * if you want to share a single validator among multiple fields (for
    ...
    @returns {Validator} validator instance or null
  */  
  findFor: function(form,field, validatorKey) {
    ...
    if (validatorKey instanceof Validator) {
      ...
      validatorKey = String.classify(validatorKey);
      var validatorClass = Validator[validatorKey] ;
