...
/**
  ...
  @version 1.0
*/
export const DateValidator = Validator.extend(
/** @scope Validator.Date.prototype */ {
  ...
  */
  fieldValueForObject: function(object, form, field) {
    ...
    */
    // @if (debug)
    if (format.indexOf('%') === -1) {
      SC.Logger.warn("You're using a Date validator with a format (%@) for time.js, which has been deprecated. Please change your format to something compatible with DateTime".fmt(format));
