...
/**
  ...
  @constant
*/
export const LIST_ITEM_ACTION_CANCEL = 'sc-list-item-cancel-action';

/**
  @static
  @constant
*/
export const LIST_ITEM_ACTION_REFRESH = 'sc-list-item-cancel-refresh';

/**
  @static
  @constant
*/
export const LIST_ITEM_ACTION_EJECT = 'sc-list-item-cancel-eject';
...
*/
export const ListItemView = View.extend(InlineEditable, Control,
/** @scope ListItemView.prototype */ {
  ...
  */
  ...
  /**
    ...
    If the list view supports the DROP_ON operation, it will set this
  ...
  */
  ...
  toggleCheckbox: function () {
    ...
    if (content && content.get) {
      ...
      value = (value === MIXED_STATE) ? true : !value;
  ...
  */
  ...
  /*
    Edits the label portion of the list item. If scrollIfNeeded is true, will
  ...
  beginEditing: function (original, scrollIfNeeded) {
    ...
    if (scrollIfNeeded && this.scrollToVisible()) {
      ...
      this.invokeLast(function () {
        ...
        if (item && item.beginEditing) item.beginEditing(false);
      });
      return true; // let the scroll happen then begin editing...
    }

    else if (!parent || !el || el.get('length') === 0) return false;
  ...
  */
  ...
  /** ListItemView is not able to update itself in place at this time. */
  ...
  */
  render: function (context, firstTime) {
    ...
    if (this.get('escapeHTML')) value = RenderContext.escapeHTML(value);
  ...
  /** @private
    ...
    something other than LEAF_NODE.

    @param {RenderContext} context the render context
    @param {Boolean} state true, false or MIXED_STATE
    @returns {void}
  */
  ...
  */
  renderCheckbox: function (context, state) {
    ...
    source
      .set('isSelected', state && (state !== MIXED_STATE))
  ...
  */
  renderIcon: function (context, icon) {
    ...
    var classArray = ['icon'];
    if (icon && ImageView.valueIsUrl(icon)) {
...
ListItemView._deprecatedRenderWarningHasBeenIssued = false;
