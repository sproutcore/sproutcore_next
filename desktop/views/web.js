...
*/
export const WebView = View.extend(Control, {/** @scope WebView.prototype */
  ...
  */
  didCreateLayer: function() {
    ...
    SCEvent.add(f, 'load', this, this.iframeDidLoad);
  },
  ...
  */
  willDestroyLayer: function() {
    ...
    SCEvent.remove(f, 'load', this, this.iframeDidLoad);
  },
