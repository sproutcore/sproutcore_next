...
import { RenderDelegate, BaseTheme, MIXED_STATE } from "../../view/view.js";
...
*/
BaseTheme.checkboxRenderDelegate = RenderDelegate.create({
  className: 'checkbox',
  ...
  render: function(dataSource, context) {
    ...
    var isSelected = dataSource.get('isSelected') || false;
    var isActive = dataSource.get('isActive');

    var ariaIsSelected;
    if (isSelected === MIXED_STATE) ariaIsSelected = 'mixed';
