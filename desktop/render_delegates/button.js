...
*/
BaseTheme.buttonRenderDelegate = RenderDelegate.create({
  className: 'button',
  ...
  /**
    ...
    @param {Object} dataSource the object containing the information on how to render the button
    @param {RenderContext} context the render context instance
  */
  render: function(dataSource, context) {
    this.addSizeClassName(dataSource, context);

    var toolTip     = dataSource.get('toolTip'),
      isSelected  = dataSource.get('isSelected') || false,
      isActive    = dataSource.get('isActive') || false,
      isDefault   = dataSource.get('isDefault') || false,
      isCancel    = dataSource.get('isCancel') || false,
      isToggle    = (dataSource.get('buttonBehavior') === TOGGLE_BEHAVIOR),
  ...
  /**
    ...
    @param {Object} dataSource the object containing the information on how to render the button
    @param {RenderContext} jquery the jQuery object representing the HTML representation of the button
  */
  update: function(dataSource, jquery) {
    var isToggle = (dataSource.get('buttonBehavior') === TOGGLE_BEHAVIOR),
