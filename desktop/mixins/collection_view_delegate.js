...
import { DROP_ON } from '../../view/view.js';
import { DRAG_NONE } from '../system/drag.js';

/**
  @namespace

  A Collection View Delegate is consulted by a `CollectionView` to make
  ...
  also want to add the `CollectionContent` mixin.
...
*/
export const CollectionViewDelegate = {

  /**
    Walk like a duck. Used to detect the mixin by CollectionView.
  ...
  */
  ...
  /**
    ...
    @param {CollectionView} view the collection view
    @param {IndexSet} sel Proposed array of selected objects.
    @returns {IndexSet} Actual allow selection index set
  */
  ...
  /**
    ...
    @param {CollectionView} view the view collection view
    @param {IndexSet} indexes the indexes to be selected
    @param {Boolean} extend true if the indexes will extend existing sel
    @returns {IndexSet} allowed index set
  */
  ...
  */
  ...
  /**
    ...
    @param {CollectionView} view the collection view
    @param {IndexSet} indexes proposed index set of items to delete.
    @returns {IndexSet} index set allowed to delete or null.
  */
  ...
  /**
    ...
    @param {CollectionView} view collection view
    @param {IndexSet} indexes the items to delete
  ...
  */
  ...
  /**
    ...
    @param {CollectionView} view the collection view
    @returns {Boolean} true to allow, false to prevent it
  */
  ...
  /**
    ...
    @param {CollectionView} view the collection view to begin dragging.
  ...
  */
  ...
  /**
    ...
    @param view {CollectionView} the collection view that initiated the drag
  ...
  */
  ...
  /**
    ...
    @param {CollectionView} view the collection view that initiated the drag
    @param {Drag} drag the drag object
  ...
  */
  ...
  /**
    ...
    If the `proposedDropOperation` parameter is `DROP_ON` or `DROP_BEFORE`,
    ...
    @param {CollectionView} view the collection view
    @param {Drag} drag the current drag object
    ...
    @param {String} proposedDropOperation the proposed drop operation. Will be one of DROP_ON, DROP_BEFORE, or DROP_ANY.
  ...
  */
  collectionViewValidateDragOperation: function(view, drag, op, proposedInsertionIndex, proposedDropOperation) {
    ...
    return (proposedDropOperation & DROP_ON) ? DRAG_NONE : op ;
  },
  ...
  /**
    ...
    `DRAG_NONE` and the dragOperation was `DRAG_REORDER`, then the default
  ...
  */
  ...
  /**
    ...
    @param {CollectionView} view
    @param {IndexSet} dragContent
    @returns {View} view or null
  */
