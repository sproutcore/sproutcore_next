...
*/
export const StatePathMatcher = SC.Object.extend(
  /** @scope StatePathMatcher.prototype */{
  ...
  _parseExpression: function() {
    ...
    for (; i < len; i += 1) {
      ...
      if (part.indexOf('~') >= 0) {
        ...
        token = StatePathMatcher._ExpandToken.create({
        ...
        token = StatePathMatcher._ThisToken.create();
      }
      
      else {
        token = StatePathMatcher._BasicToken.create({
          value: part
        });
      }
...
*/
StatePathMatcher._Token = SC.Object.extend({
...
*/
StatePathMatcher._BasicToken = StatePathMatcher._Token.extend({
...
*/
StatePathMatcher._ExpandToken = StatePathMatcher._Token.extend({
...
/** @private @class
  ...
  token represents.
*/
StatePathMatcher._ThisToken = StatePathMatcher._Token.extend({
