...
/** @class
  ...
  single Application instance as your root namespace. Application is
  required if you intend to use Responder to route events.

  ## Example

      Contacts = Application.create({
        store: Store.create(Record.fixtures),
...
*/
export const Application = Responder.extend(ResponderContext,
/** @scope Application.prototype */ {
  ...
  */
  ...
  /**
    ...
    of code,
        ...
        customView: View.extend({
          ...
          modeAdjust: {
            ...
            m_p: { alignment: ALIGN_CENTER }, // Overrides for medium - portrait mode.
    ...
    as found in the DESIGN_MODE_CLASS_NAMES hash. By default, your
  ...
  */
  ...
  _setDesignModes: function () {
    ...
    if (designModes) {
      ...
      // UNUSED.
      // this.bind('designMode', Binding.from('RootResponder.responder.currentDesignMode'));
    }
  }
