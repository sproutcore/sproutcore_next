...
test("should get observers", function() {
  ...
  assert.equal(o1.observersForKey('foo').get('length'), 0, "o1.observersForKey should return empty array");
  ...
  assert.equal(observers.get('length'), 2, "o2.observersForKey should return an array with length 2");
