...
import { clearHtmlbody, CoreTest, htmlbody } from "../../../../testing/core.js";
import { Control, View } from "../../../../view/view.js";
import { ControlTestPane } from "../../../view/test_support/control_test_pane.js";

/* Test StackedView with a Comments example. */

var ShapeView = View.extend(Control, {
...
var ShapeCanvasView = CollectionView.extend({
  ...
  mouseDown: function md(ev) {
    var ret = md.base.apply(this, arguments);
    if (ret) {
  ...
  mouseDragged: function mdr (ev) {
    ...
    if (!anchor) return mdr.base.apply(this, arguments);
