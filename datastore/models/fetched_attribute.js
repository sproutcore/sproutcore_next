...
/** @class
  ...
  The return value is usually an `RecordArray` that will populate with the
  record data so that you can display it.

  
  @since SproutCore 1.0
*/
export const FetchedAttribute = RecordAttribute.extend(
  /** @scope FetchedAttribute.prototype */ {
  ...
  */
  ...
  toType: function(record, key, value) {
    ...
    // make request - should return RecordArray instance
