...
export const ChildArray = SC.Object.extend(SC.Enumerable, SC.Array,
  ...
  */
  replace: function(idx, amt, recs) {
    ...
    // Convert any Record objects into JavaScript objects.
    ...
    // All current Record instances must be updated to their new backing object.
    // For example, when passing an Record object in, that instance should
  ...
  */
  recordPropertyDidChange: function (keys) {
    ...
    // Store#writeDataHash which can't handle this.
